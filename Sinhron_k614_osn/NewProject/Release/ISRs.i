...
extern volatile unsigned  int        sch_event_sinhron; 
...
extern volatile  unsigned int  text_lengh;
  ...
  extern unsigned int TIMER_UDP_LS_DOWN;
  extern unsigned int TIMER_AVARIYA;
  extern char FLAG_SPORT1_TX;
  extern char FLAG_SPORT1_RX;
  extern unsigned int DELAY_RZV;
  extern volatile  unsigned int TIME_PPI_END;
  extern unsigned int TIMER_REZERV; 
  extern unsigned int TIMER_GBR_OK;
  extern unsigned int FLAG_TIMER_UART_K614;
  extern unsigned int TIMER_RS485_OBMEN;
  extern volatile unsigned int TIME_WORK_CONTROL;
  extern volatile unsigned int TIME_PPI_OK;
  extern volatile unsigned int TIMER_FINDER;
  extern unsigned short FLAG_ERROR_PPI;
   
 

extern volatile unsigned char        tx_buffer1[64];
...
{  
    ssync();
    *((volatile unsigned short *)0xFFC00648) = 0x0001;
    ssync();
...
{									
	...
	*((volatile unsigned short *)0xFFC00C28) = 0x1;
    ...
    TIME_PPI_END = *((volatile unsigned long *)0xFFC00624); 
...
_Pragma("interrupt") void PPI_ERROR_ISR (void)
{
	...
	FLAG_ERROR_PPI=*((volatile unsigned short *)0xFFC01004);
}
...
{                 
  ...
  *((volatile unsigned short *)0xFFC00D68) = 0x1;
    ssync(); 
...
_Pragma("interrupt") void FlagA_ISR (void)
{
           ...
           *((volatile unsigned short *)0xFFC00704) = 0x0001;
                      ssync();
              flag_1HZ_sync=1;
...
_Pragma("interrupt") void FlagB_ISR (void)
{
	...
	*((volatile unsigned short *)0xFFC00704) = 0x0010;   

  ssync();
  
  flag_event_sinhron=1; 
  sch_event_sinhron++;
	ssync();
...
_Pragma("interrupt") void UART_DMA_ISR (void)
  {     
    ...
    *((volatile unsigned short *)0xFFC00DE8) = 0x0001;
...
_Pragma("interrupt") void SPORT1_TX_ISR (void)
  {     
    ...
    *((volatile unsigned short *)0xFFC00D28) = 0x0001;
...
ssync(); 
       if (tx_rd_index1 == 64) tx_rd_index1=0;
      }
       else
         {
...
{     
    ...
    *((volatile unsigned short *)0xFFC00CE8) = 0x0001;
 ssync(); 
     FLAG_SPORT1_RX++;
ssync(); 	 
	 data = *((volatile unsigned short *)0xFFC00918);
ssync(); 
	 
  rx_buffer1[rx_wr_index1]=data;
  if (++rx_wr_index1 == 650) rx_wr_index1=0;
  if (++rx_counter1 == 650)
	{
		rx_counter1=0;
