...
extern unsigned char RcvBufOverflow_flag;      
                                        
extern  unsigned char BufIsRead_flag;        
extern  unsigned char Data4TrAbsent_flag;    
...
volatile char rx_buffer0[256];   
 ...
 unsigned int CLKIN = 2000000;  
  ...
  int UART_getSCLK(void)
  {
	...
	tempPLLCTL = *((volatile unsigned short *)0xFFC00000);
	tempPLLDIV = *((volatile unsigned short *)0xFFC00004);
...
void UART_init ( int speed )
 { int divisor=0, SCLK=0;
   ...
   *((volatile unsigned short *)0xFFC00424) = 0x01;
  
  
   *((volatile unsigned short *)0xFFC0040C) = 0x80;
   *((volatile unsigned short *)0xFFC00400) = divisor;       
   *((volatile unsigned short *)0xFFC00404) = divisor>>8;    
  
   *((volatile unsigned short *)0xFFC0040C) = (((8)-5) & 0x03);
   ssync();
 }
 ...
 _Pragma("interrupt") void UART_ISR (void)
  { volatile unsigned stat;
    ...
    stat= *((volatile unsigned short *)0xFFC00408);
    stat= stat>>1;
    ...
    if ( stat == 0x0 )
     ...
     else if ( (stat&0x2) == 0x2 )  
            {                       
             t= *((volatile unsigned short *)0xFFC00400);
