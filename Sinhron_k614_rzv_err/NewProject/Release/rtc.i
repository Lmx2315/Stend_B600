...
extern unsigned tested;
 ...
 void Init_RTC (void)
  {
	*((volatile unsigned long *)0xFFC00124) = 0x80;     
	*((volatile unsigned short *)0xFFC00314) = 0x1;     
    while ((*((volatile unsigned short *)0xFFC00308)&0x8000)==0);    

    *((volatile unsigned short *)0xFFC0030C) = 0x0010 ;          
    while ((*((volatile unsigned short *)0xFFC00308)&0x8000)==0);   
                            
    
    

    *((volatile unsigned short *)0xFFC00304) =  0x0004 | 0x0008 | 0x0010 | 0x0001;
    while ((*((volatile unsigned short *)0xFFC00308)&0x8000)==0);  
  ...
  _Pragma("interrupt") void RTC_ISR2 (void)
   {
     statu=*((volatile unsigned short *)0xFFC00308);    
     ...
     if ( (statu&0x0004) != 0 )
       { 
         ...
         if ( DontConnect_flag )
           CntDown--;
         if ( !CntDown )      
           *(volatile unsigned char *)0x20270005 = 0x1; 
       }
     if ( (statu&0x8) != 0 )  
       {
      ...
      *((volatile unsigned short *)0xFFC00308)=0xf;
         while ((*((volatile unsigned short *)0xFFC00308)&0x8000)==0);
         statu=*((volatile unsigned short *)0xFFC00308);

     statu=0;
	 *((volatile unsigned short *)0xFFC00304)=0;
	 while ((*((volatile unsigned short *)0xFFC00308)&0x8000)==0);
   }
