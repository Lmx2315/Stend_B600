...
.epcdebug:
	...
	.byte4 = .LN._UART_ISR.end;
	.byte =
		0x0F,0x73,0x74,0x61,0x74,0x00,0x01,0x60,0x07,0x00,0x00,0x02,
		0x7F,0x78,0x00,0x00,0x00,0x00,0x00,0x0F,0x74,0x00,0x01,0x60,
		0x07,0x00,0x00,0x02,0x7F,0x7C,0x00,0x00,0x00,0x00,0x00,0x00,
		0x00,0x0C,0xEB,0x01,0x00,0x00,0x0D,0x92,0x07,0x00,0x00,0x55,
	...
	.byte4 = .LN._UART_ERR_ISR.end;
	.byte =
		0x00,0x00,0x10,0xC3,0x07,0x00,0x00,0x55,0x41,0x52,0x54,0x5F,
		0x67,0x65,0x74,0x53,0x43,0x4C,0x4B,0x00,0x01;
	.byte4 = .LN_UART_getSCLK;
	.byte4 = .LN._UART_getSCLK.end;
	.byte =
		0x01,0xD6,0x01,0x00,0x00,0x01,0x00,0x0E,0x00,0x00,0x00,0x00;
	.byte4 = .LN15;
	.byte4 = .LN._UART_getSCLK.end;
	.byte =
		0x00,0x00,0x0D,0xED,0x07,0x00,0x00,0x55,0x41,0x52,0x54,0x5F,
	...
	.byte =
		...
		0x65,0x78,0x30,0x00,0x01,0x60,0x07,0x00,0x00,0x05,0x03;
	.byte4 = _rx_wr_index0;
	.byte =
		0x00,0x00,0x00,0x00,0x00,0x0F,0x72,0x78,0x5F,0x72,0x64,0x5F,
		0x69,0x6E,0x64,0x65,0x78,0x30,0x00,0x01,0x60,0x07,0x00,0x00,
		0x05,0x03;
	.byte4 = _rx_rd_index0;
	.byte =
		0x00,0x00,0x00,0x00,0x00,0x0F,0x72,0x78,0x5F,0x63,0x6F,0x75,
		0x6E,0x74,0x65,0x72,0x30,0x00,0x01,0x60,0x07,0x00,0x00,0x05,
		0x03;
	.byte4 = _rx_counter0;
	.byte =
		0x00,0x00,0x00,0x00,0x00,0x0F,0x72,0x78,0x5F,0x62,0x75,0x66,
		0x66,0x65,0x72,0x30,0x00,0x01,0xA3,0x08,0x00,0x00,0x05,0x03;
	.byte4 = _rx_buffer0;
	.byte =
		0x00,0x00,0x00,0x00,0x00,0x0F,0x72,0x78,0x5F,0x62,0x75,0x66,
		0x66,0x65,0x72,0x5F,0x6F,0x76,0x65,0x72,0x66,0x6C,0x6F,0x77,
		0x30,0x00,0x01,0x83,0x01,0x00,0x00,0x05,0x03;
	.byte4 = _rx_buffer_overflow0;
	.byte =
		0x00,0x00,0x00,0x00,0x00,0x0F,0x43,0x4C,0x4B,0x49,0x4E,0x00,
		0x01,0xEB,0x01,0x00,0x00,0x05,0x03;
	.byte4 = _CLKIN;
	.byte =
		0x00,0x00,0x00,0x00,0x00,0x0C,0x83,0x01,0x00,0x00,0x11,0xB3,
		0x08,0x00,0x00,0x9E,0x08,0x00,0x00,0x12,0x80,0x02,0x00,0xFF,
		0x01,0x00,0x00,0x00;
.epcdebug.end:
...
.epcline:
	...
	.inc/binary ".\Release\uart.sbn", 2029, 570;
	.byte4 = .LN_UART_ISR;
	.byte =
...
.epcpubnames:
	...
	.byte4 = .epcdebug;
	.inc/binary ".\Release\uart.sbn", 2599, 168;
.epcpubnames.end:
